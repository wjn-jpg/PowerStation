...
import com.ntdq.power_station.nettyHandler.tcp.init.client.Nbt33007ClientChannelInitializer;
...
public class Nbt33007ClientProcess implements ServerProcess {
    ...
    public void startServer(ServerBaseConfiguration appConfiguration) {
        ...
        NettyConfiguration nettyConfiguration = new NettyConfiguration()
                .setHost(nbt33007BOBase.getClientIp())
                .setPort(nbt33007BOBase.getClientPort())
                .setHandlerClass(Nbt33007ClientChannelInitializer.class)
